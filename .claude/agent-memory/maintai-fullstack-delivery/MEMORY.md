...
- [feedback_ticket_page_truncation.md](feedback_ticket_page_truncation.md) — ticket/page.tsx was truncated by a previous edit; restore from git when found broken
