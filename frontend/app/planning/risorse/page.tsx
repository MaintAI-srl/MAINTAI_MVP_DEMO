...
// ─── UnscheduledItem (draggable sidebar card) ─────────────────────────────────
...
// ─── DayRow — one technician row in day view ──────────────────────────────────
...
// ─── DayCell — one cell in week/2week view ────────────────────────────────────
...
// ─── MultiDayRow — technician row in week/2week view ─────────────────────────
...
// ─── TecnicoLabel — sticky left column ───────────────────────────────────────
...
export default function RisorseSchedulerPage() {
                        ...
                        return (
                          ...
                          >
                            <div
                              style={{
                                fontSize: 9,
                                color: today ? "#60a5fa" : "var(--text-muted)",
                                letterSpacing: "0.1em",
                              }}
                            >
                            ...
                            <div
                              style={{
                                ...
                                color: today ? "#60a5fa" : "var(--text-primary)",
                              }}
                            >
                              {format(day, "d")}
                            </div>
