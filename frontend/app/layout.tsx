      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var DESIGN=430;var m=document.querySelector('meta[name="viewport"]');if(!m)return;var natural=window.__mvVW||window.innerWidth||document.documentElement.clientWidth||0;window.__mvVW=natural;function apply(){try{var coarse=!window.matchMedia||window.matchMedia('(pointer: coarse)').matches;var landscape=window.matchMedia&&window.matchMedia('(orientation: landscape)').matches;var want=(coarse&&!landscape&&natural>470&&natural<1600)?('width='+DESIGN+', viewport-fit=cover'):'width=device-width, initial-scale=1, viewport-fit=cover';if(m.getAttribute('content')!==want)m.setAttribute('content',want);}catch(e){}}apply();window.addEventListener('orientationchange',function(){setTimeout(apply,350);});}catch(e){}})();`,
          }}
        />
