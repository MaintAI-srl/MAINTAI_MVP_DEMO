  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* Header */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px 20px 12px", borderBottom: "1px solid #1e293b", background: "linear-gradient(180deg, rgba(59,130,246,0.08), transparent)" }}>
          <div>
            ...
            <div style={{ fontSize: 17, fontWeight: 800, color: "#f8fafc" }}>Nuovo Intervento</div>
          </div>
        ...
        <form onSubmit={handleSubmit} style={{ padding: "16px 20px", display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              {(["BD", "PM", "CM"] as const).map(t => (
                <button
                  ...
                  style={{
                    ...
                    border: tipo === t ? `1.5px solid ${tipoColors[t]}` : "1.5px solid #334155",
                    background: tipo === t ? tipoColors[t] + "22" : "#1e293b",
          ...
          <div>
            ...
            <input
              ...
              style={{ width: "100%", background: "#1e293b", color: "#f8fafc", border: "1px solid #334155", borderRadius: "6px 6px 0 0", padding: "8px 12px", fontSize: 13, outline: "none", boxSizing: "border-box" }}
            />
            <select
              value={assetId}
              ...
              style={{ width: "100%", background: "#1e293b", color: "#f8fafc", border: "1px solid #334155", borderTop: "none", borderRadius: "0 0 6px 6px", padding: "4px 0", fontSize: 13, outline: "none", boxSizing: "border-box" }}
            >
          ...
          <div>
            ...
            <textarea
              ...
              style={{ width: "100%", background: "#1e293b", color: "#f8fafc", border: "1px solid #334155", borderRadius: 6, padding: "8px 12px", fontSize: 13, outline: "none", resize: "none", boxSizing: "border-box", fontFamily: "inherit" }}
            />
          </div>
